...
const resources = {
  ...
  products: {
    ...
    defaultOrderBy: { orderIndex: "asc" as const },
    fields: [
      { key: "categoryId", label: "Product Category", type: "select", relationResource: "categories", required: true, list: true },
      ...
      { key: "finish", label: "Finish", type: "text", required: true },
      { key: "impactIsolationClass", label: "Impact Isolation Class", type: "text", required: true },
      { key: "installation", label: "Installation", type: "text", required: true },
      { key: "lockingSystem", label: "Locking System", type: "text", required: true },
      { key: "printedDesign", label: "Printed Design", type: "text", required: true },
      { key: "soundTransmission", label: "Sound Transmission", type: "text", required: true },
      { key: "species", label: "Species", type: "text", required: true },
      { key: "wearLayer", label: "Wear Layer", type: "text", required: true },
      { key: "accessoryNosing", label: "Accessory - Nosing", type: "text" },
      { key: "accessoryReducer", label: "Accessory - Reducer", type: "text" },
      { key: "accessoryTmold", label: "Accessory - T-Mold", type: "text" },
      { key: "referenceInstallationUrl", label: "Reference - Installation PDF", type: "text" },
      { key: "referenceSpecSheetUrl", label: "Reference - Specification Sheet PDF", type: "text" },
      { key: "referenceWarrantyUrl", label: "Reference - Warranty PDF", type: "text" },
